...
<head>
    <meta charset="UTF-8">
    <title>Management Sekolah - Kepsek</title>
...
<body class="bg-white text-gray-800 font-GabaritoRegular h-screen">
    <div class="w-full min-h-screen flex">
        <!-- Sidebar -->
        <aside class="flex flex-col justify-start w-1/5 h-screen bg-white text-black p-4" x-data="{ openMenu: null }">
            ...
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    <ul x-show="openMenu === 1" x-collapse class="ml-16 mt-1 space-y-1 text-sm">
                        <li><a href="{{ route('kepsek.laporan.perpanjang') }}"
                                class="block text-base px-4 py-2 hover:bg-[#232A3E] hover:rounded-2xl hover:text-white {{ Route::current()->getName() == 'kepsek.laporan.perpanjang' ? 'bg-[#232A3E] rounded-2xl text-white' : '' }}">Perpanjang</a>
                        </li>
                        <li><a href="{{ route('kepsek.laporan.pengangkatan') }}"
                                class="block text-base px-4 py-2 hover:bg-[#232A3E] hover:rounded-2xl hover:text-white {{ Route::current()->getName() == 'kepsek.laporan.pengangkatan' ? 'bg-[#232A3E] rounded-2xl text-white' : '' }}">Pengangkatan</a>
                        </li>
                        <li><a href="{{ route('kepsek.laporan.pemberhentian') }}"
        ...
        <div class="w-4/5 min-h-screen bg-gray-100 p-5"
            ...
            <div class="flex justify-end items-center space-x-2 relative" x-data="{ open: false }">
                <!-- Notifikasi -->
                <a href="{{ route('kepsek.notification') }}">
                ...
                <div x-show="open" @click.outside="open = false" x-transition
                    ...
                    <a href="{{ route('kepsek.profile') }}" class="block px-4 py-2 hover:text-blue-400">
                        <i class="fa-solid fa-user text-sm me-3"></i>
                        Profile
                    </a>
                    <a href="{{ route('kepsek.change-pass') }}" class="block px-4 py-2 hover:text-blue-400">
            ...
            <footer class="flex flex-col justify-center items-center mt-5">
                <p class="font-GabaritoRegular text-sm">Developed by Ananda</p>

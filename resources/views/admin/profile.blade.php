    ...
    <div class="w-full h-fit bg-white rounded-lg my-5 p-5">
                        ...
                        <div class="relative p-4 w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow-sm">
                                ...
                                <div class="p-4 md:p-5 space-y-4">
                                    <form action="{{ route('admin.profile.add-alamat') }}" method="POST">
                                        @csrf
        ...
        <div class="my-5 hidden tab-content" id="kontak-darurat">
                ...
                <div id="default-modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow-sm">
                            ...
                            <!-- Modal body -->
                            <div class="p-4 md:p-5 space-y-4">
                                <form action="{{ route('admin.profile.store.kondar') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="id_karyawan" value="{{ $dataPribadi->id_karyawan }}">
                                    <table class="w-full border border-gray-300 text-sm text-left text-gray-500">
                                        <tbody>
            ...
            @foreach ($dataKontak as $a)
                <form action="{{ route('admin.profile.updateKontak') }}" method="POST">
                    @csrf
                    ...
                    <div class="flex justify-end items-center my-5 space-x-2">
                        <a href="{{ route('admin.profile.delete.kondar', ['id' => $a->id_kontak_darurat]) }}"
        ...
        <div class="my-5 hidden tab-content" id="pendidikan">
                ...
                <div id="default-modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow-sm">
                            ...
                            <!-- Modal body -->
                            <div class="p-4 md:p-5 space-y-4">
                                <form action="{{ route('admin.profile.add-pendidikan') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="id_karyawan" value="{{ $dataPribadi->id_karyawan }}">
                                    <table class="w-full border border-gray-300 text-sm text-left text-gray-500">
                                        <tbody>
            ...
            @foreach ($dataPendidikan as $a)
                <form action="{{ route('admin.profile.update-pendidikan') }}" method="POST">
                    ...
                    <div class="flex justify-end mb-10 space-x-5 mt-3">
                        <a href="{{ route('admin.profile.delete-pendidikan', ['id' => $a->id_riwayat_pendidikan]) }}"

    ...
    <div class="w-full h-fit bg-white rounded-lg my-5 p-5">
                            ...
                            <td class="px-4 py-2 text-gray-500 italic">
                                <select name="id_agama"
                                    ...
                                    @foreach ($MasterAgama as $key)
                                        <option value="{{ $key->agama }}"
                                            {{ $dataPribadi->agama == $key->agama ? 'selected' : '' }}>
                                            {{ $key->agama }}</option>
                                    @endforeach
                                </select>
                            </td>
        ...
        <div class="my-5 hidden tab-content" id="alamat">
            ...
            @foreach ($dataAlamat as $index => $key)
                ...
                <form action="{{ route('user.profile.update-alamat') }}" method="POST">
                    @csrf
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-2 text-gray-500 italic">
                                    <select id="jenis_alamat" name="jenis_alamat"
                                        ...
                                        <option value="{{ $key->jenis_alamat }}" selected>{{ $key->jenis_alamat }}</option>
                                    </select>
                                </td>
                            </tr>
                            <tr class="border-b">
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-2">
                                    ...
                                    <select name="provinsi" id="provinsi_{{ $index }}"
                                        ...
                                        data-selected="{{ $key->id_provinsi }}" class="w-full
        ...
        <div class="my-5 hidden tab-content" id="kontak-darurat">
                ...
                <div id="default-modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow-sm">
                            ...
                            <!-- Modal body -->
                            <div class="p-4 md:p-5 space-y-4">
                                <form action="{{ route('user.profile.store.kondar') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="id_karyawan" value="{{ $dataPribadi->id_karyawan }}">
                                    <table class="w-full border border-gray-300 text-sm text-left text-gray-500">
                                        <tbody>
            ...
            @foreach ($dataKontak as $a)
                <form action="{{ route('user.profile.updateKontak') }}" method="POST">
                    @csrf
                    ...
                    <div class="flex justify-end items-center my-5 space-x-2">
                        <a href="{{ route('user.profile.delete.kondar', ['id' => $a->id_kontak_darurat]) }}"
        ...
        <div class="my-5 hidden tab-content" id="penggajian">
            ...
            <form action="{{ route('user.profile.updatePenggajian') }}" method="POST">
                @csrf
                <input type="hidden" name="id_karyawan" value="{{ $dataPribadi->id_karyawan }}">
                <table class="w-full border border-gray-300 text-sm text-left text-gray-500">
                    <tbody>
        ...
        <div class="my-5 hidden tab-content" id="pendidikan">
                ...
                <div id="default-modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow-sm">
                            ...
                            <!-- Modal body -->
                            <div class="p-4 md:p-5 space-y-4">
                                <form action="{{ route('user.profile.add-pendidikan') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="id_karyawan" value="{{ $dataPribadi->id_karyawan }}">
                                    <table class="w-full border border-gray-300 text-sm text-left text-gray-500">
                                        <tbody>
            ...
            @foreach ($dataPendidikan as $a)
                <form action="{{ route('user.profile.update-pendidikan') }}" method="POST">
                    ...
                    <div class="flex justify-end mb-10 space-x-5 mt-3">
                        <a href="{{ route('user.profile.delete-pendidikan', ['id' => $a->id_riwayat_pendidikan]) }}"

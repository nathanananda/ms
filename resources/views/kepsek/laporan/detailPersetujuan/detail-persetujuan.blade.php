...
@section('content-user')
    <div class="flex flex-col justify-start my-5">
        <h3 class="font-GabaritoMedium text-2xl">Detail Persetujuan</h3>
    ...
    <div class="w-full min-h-screen bg-white rounded-xl p-5">
        ...
        <div class="flex justify-end items-center space-x-5">
            ...
            <!-- Modal Penolakan -->
            <div id="modal-tolak" tabindex="-1" aria-hidden="true"
            ...
            @if ($dataKaryawan->tipe_kontrak == 'Perpanjang')
            ...
            @elseif ($dataKaryawan->tipe_kontrak == 'Pemberhentian')
            ...
            @elseif ($dataKaryawan->tipe_kontrak == 'Pengangkatan')
            ...
            @elseif ($dataKaryawan->tipe_kontrak == 'Penambahan')

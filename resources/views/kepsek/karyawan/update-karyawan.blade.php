...
@section('content-user')
    ...
    <div class="w-full h-fit bg-white rounded-lg my-5 p-5">
        ...
        <div class="my-5 tab-content" id="data-pribadi">
            ...
            <form action="{{ route('kepsek.detail.karyawan.updateProfile') }}" method="POST">
                @csrf
        ...
        <div class="my-5 hidden tab-content" id="kontak-darurat">
            ...
            <form action="{{ route('kepsek.detail.karyawan.updateKontak'    ) }}" method="POST">
                @csrf
        ...
        <div class="my-5 hidden tab-content" id="kepegawaian">
            ...
            <form action="{{ route('kepsek.detail.karyawan.updateKepegawaian') }}" method="POST">
                @csrf
                <input type="hidden" name="id_karyawan" value="{{ $dataPribadi->id_karyawan }}">
                <table class="w-full border border-gray-300 text-sm text-left text-gray-500">
                    <tbody>
        ...
        <div class="my-5 hidden tab-content" id="penggajian">
            ...
            <form action="{{ route('kepsek.detail.karyawan.updatePenggajian') }}" method="POST">
                @csrf
                <input type="hidden" name="id_karyawan" value="{{ $dataPribadi->id_karyawan }}">
                <table class="w-full border border-gray-300 text-sm text-left text-gray-500">
                    <tbody>
        ...
        <div class="my-5 hidden tab-content" id="pendidikan">
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow-sm">
                            ...
                            <div class="p-4 md:p-5">
                                <form action="{{ route('kepsek.detail.karyawan.add-pendidikan') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="id_karyawan" value="{{ $dataPribadi->id_karyawan }}">
                                    <table
            ...
            @foreach ($dataPendidikan as $a)
                <form action="{{ route('kepsek.detail.karyawan.update-pendidikan') }}" method="POST">
                    @csrf
                    ...
                    <div class="flex justify-between items-center my-5">
                        <a href="{{ route('kepsek.detail.karyawan.delete-pendidikan', ['id' => $a->id_riwayat_pendidikan]) }}"

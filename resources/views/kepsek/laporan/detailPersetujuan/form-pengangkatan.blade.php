...
@section('content-user')
    ...
    <div class="w-full min-h-screen bg-white rounded-xl p-5">
            ...
            <div class="w-1/2">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_lengkap" id="nama_lengkap" disabled
                        value="{{ $dataKaryawan->nama_lengkap }}" disabled
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="mb-4">
                    ...
                    <input type="date" name="awal_kontrak" id="awal_kontrak" required
                        value="{{ $dataKaryawan->awal_kontrak }}" disabled
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                @if ($dataKaryawan->akhir_kontrak != null)
                    <div class="mb-4">
                        ...
                        <input type="date" name="akhir_kontrak" id="akhir_kontrak" required
                            value="{{ $dataKaryawan->akhir_kontrak }}" disabled
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                @endif
                <div class="mb-4">
                    <label for="jabatan" class="block text-sm font-medium text-gray-700">Jabatan</label>
                    <input type="text" name="id_jabatan" id="id_jabatan" disabled value="{{ $dataKaryawan->jabatan }}"
                        disabled
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="mb-4">
        ...
        <div class="flex justify-end items-center space-x-5">
            <form action="{{ route('kepsek.laporan.persetujuan.approve-kontrak-pengangkatan') }}" method="POST">
                @csrf

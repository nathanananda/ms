...
class KepsekProfileController extends Controller
{
    ...
    public function addPendidikan(Request $request)
    {
        try {
            ...
            return redirect()->route('kepsek.profile')->with('toast_success', 'Pendidikan berhasil ditambahkan !');
        } catch (\Throwable $th) {
            return redirect()->route('kepsek.profile')->with('toast_error', 'Pendidikan gagal ditambahkan !');
        }
    }
    ...
    public function updatePendidikan(Request $request)
    {
        try {
            ...
            return redirect()->route('kepsek.profile')->with('toast_success', 'Pendidikan berhasil diubah !');
        } catch (\Throwable $th) {
            return redirect()->route('kepsek.profile')->with('toast_error', 'Pendidikan gagal diubah !');
        }
    }
    ...
    public function deletePendidikan($id)
    {
        try {
            ...
            $data->save();
            return redirect()->route('kepsek.profile')->with('toast_success', 'Pendidikan berhasil dihapus !');
        } catch (\Throwable $th) {
            return redirect()->route('kepsek.profile')->with('toast_error', 'Pendidikan gagal dihapus !');
        }
    }
    ...
    {
        try {
            $data = Karyawan::where('id_karyawan', $request->id_karyawan)->first();

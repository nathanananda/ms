...
@section('content-user')
    ...
    <div class="w-full min-h-screen bg-white rounded-xl p-5">
        ...
        <form action="{{ route('kepsek.laporan.pemberhentian.store') }}" method="POST">
            @csrf
                ...
                <div class="w-1/2">
                    ...
                    <div class="mb-4">
                        <label for="awal_kontrak" class="block text-sm font-medium text-gray-700">Tanggal Mulai
                            Kontrak</label>
                        <input type="date" name="awal_kontrak" id="awal_kontrak" required disabled
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="mb-4">
                        <label for="akhir_kontrak" class="block text-sm font-medium text-gray-700">Tanggal Berakhir
                            Kontrak</label>
                        <input type="date" name="akhir_kontrak" id="akhir_kontrak" required disabled
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="mb-4">
        ...
        document.getElementById('nik').addEventListener('change', function() {
            ...
            fetch(apiUrl)
                ...
                .then(data => {
                    ...
                    document.getElementById('id_kontrak').value = data.uuid || '';
                });
        });
    </script>
@endsection

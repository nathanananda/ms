        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li class="inline-flex items-center">
                    <a href="{{ route('admin.offboarding') }}"
    ...
    <div class="w-full min-h-screen bg-white rounded-xl p-5">
        ...
        <form action="">
            <div class="flex justify-between items-start my-5 space-x-3">
                <div class="w-1/2">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="jabatan" id="jabatan" disabled value="{{ $dataKaryawan->jabatan }}"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="mb-4">
            ...
            <div class="flex justify-center items-center">
                <button class="inline-flex items-center font-GabaritoRegular text-white px-4 py-1 rounded-lg text-sm bg-[#557EF8] hover:bg-blue-700">
                    Simpan
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-device-floppy ms-3">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
